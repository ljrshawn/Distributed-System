...
public class Councilors {
    ...
    public void startServer() throws IOException {
        ...
        try {
            // Log path
//            String path = this.candidate + "_log" + ".txt";
...
//        // Backup receive information
//        File backup = new File(path);
//        if (!backup.exists()) {
//            backup.createNewFile();
//        }
//
//        FileWriter fileWriter = new FileWriter(backup, true);
...
//            bufferedWriter.write("prepare ::  " + this.resN + "," + this.proposal.getStatus() + "\n");
        } else {
...
//                    bufferedWriter.write("prepare ::  " + this.resN + ",   " + "null"
//                            + this.proposal.getStatus() + "\n");
                } else {
                    this.proposal.setStatus("reject");
//                    bufferedWriter.write("prepare ::  " + this.resN + ",   " + this.proposal.getStatus() + "\n");
                }
...
//                    bufferedWriter.write("prepare ::  " + this.resN + ",   " + this.votingName
//                            + this.proposal.getStatus()  + "\n");
                } else {
                    this.proposal.setStatus("reject");
//                    bufferedWriter.write("prepare ::  " + this.resN + ",   " + this.proposal.getStatus() + "\n");
...
//        BufferedWriter bufferedWriter = new BufferedWriter(fileWriter);
        ...
        if (this.needProposal) {
            this.proposal.setStatus("reject");
//            bufferedWriter.write("commit ::  " + this.resN + ",   " + this.proposal.getStatus() + "\n");
        } else {
            ...
            if (pResN >= this.resN) {
                ...
                this.proposal.setValue(this.votingName);
                this.proposal.setStatus("promise");
//                bufferedWriter.write("commit  ::  " + this.resN + ",   " + this.votingName
//                        + this.proposal.getStatus() + "\n");
//                bufferedWriter.close();
//                fileWriter.close();
            } else {
